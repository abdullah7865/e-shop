                        ...
                        <div class="col-lg-6 py-lg-5">
                            <div class="d-flex flex-column h-100 justify-content-center">
                                ...
                                <div>
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" id="password_confirmation" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Enter your password">
                                ...
                                <p class="mt-auto text-danger text-center">I already have an account <a
                                        href="{{ route('login') }}" class="text-dark fw-bold ms-1">Sign In</a></p>
                            </div>
                        </div>
                    </div>
                </div>
