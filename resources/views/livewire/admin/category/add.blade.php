                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div class="fallback">
                                  <input name="file" multiple wire:model="files" type="file" />
                              </div>
                          ...
                          <div class="card-body">
                              <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                      ...
                                      @error('createdBy') <span class="text-danger">{{ $message }}</span> @enderror
                                  </div>
                                  ...
                                  <div class="col-lg-12">
                                      <div class="mb-0">
                                          ...
                                          <textarea class="form-control bg-light-subtle" id="description" rows="7"
                                                    placeholder="Type description" wire:model="description"></textarea>
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <div class="mb-3">
                                          ...
                                          @error('metaTitle') <span class="text-danger">{{ $message }}</span> @enderror
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-lg-6">
                                      <div class="mb-3">
                                          ...
                                          <input type="text" id="meta-tag" class="form-control" placeholder="Enter word"
                                                 wire:model="metaTag">
                                          @error('metaTag') <span class="text-danger">{{ $message }}</span> @enderror
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-lg-12">
                                      <div class="mb-0">
                                          ...
                                          <textarea class="form-control bg-light-subtle" id="meta-description" rows="4"
                                                    placeholder="Type description" wire:model="metaDescription"></textarea>
