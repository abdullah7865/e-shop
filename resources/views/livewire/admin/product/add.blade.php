                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select wire:model="category_id" class="form-control" id="product-categories"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select wire:model="gender" class="form-control" id="gender" data-choices
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2" role="group" aria-label="Basic checkbox toggle button group">
                                        @foreach ($sizes as $size)
                                            <input type="checkbox" multiple wire:model="selectedSizes" value="{{ $size->id }}" class="btn-check" id="size-{{ $size->id }}">
                                            <label class="btn btn-light avatar-sm rounded d-flex justify-content-center align-items-center" for="size-{{ $size->id }}">
                                                {{ $size->size_label }}
                                            </label>
                                        @endforeach
                                    </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2" role="group" aria-label="Basic checkbox toggle button group">
                                        @foreach ($colors as $color)
                                            <input type="checkbox" multiple wire:model="selectedColors" value="{{ $color['color_name'] }}" class="btn-check" id="color-{{ strtolower($color['color_name']) }}">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea wire:model="description" class="form-control bg-light-subtle" id="description" rows="7"
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input wire:model="tag_number" type="number" id="product-id" class="form-control"
                                        placeholder="#******">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input wire:model="stock" type="number" id="product-stock" class="form-control"
                                        placeholder="Quantity">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <label for="product-stock" class="form-label">Tag</label>
                                <select multiple wire:model="tag" class="form-control" id="choices-multiple-remove-button" data-choices data-choices-removeItem name="choices-multiple-remove-button">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input wire:model="price" type="number" id="product-price" class="form-control" placeholder="000">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input wire:model="discount" type="number" id="product-discount" class="form-control"
                                        placeholder="000">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input wire:model="tax" type="number" id="product-tex" class="form-control" placeholder="000">
                                </div>
                            </div>
                        </div>
                    </div>
