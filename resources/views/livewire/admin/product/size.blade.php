    <div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form wire:submit.prevent="addSize">
                                                <div class="mb-3">
                                                    <label for="sizeLabel" class="form-label">Size Label</label>
                                                    <input type="text" wire:model="sizeLabel" class="form-control"
                                                        id="sizeLabel" required>
                                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <button onclick="confirmDeletion({{ $size->id }})" class="btn btn-soft-danger btn-sm">
        ...
        <script>
           ...
           var myModalEl = document.getElementById('addSizeModal');
       ...
       window.addEventListener('swal', event => {
           ...
           function confirmDeletion(sizeId) {
            Swal.fire({
                title: 'Are you sure?',
