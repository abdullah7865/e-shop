                        ...
                        <div class="filter-sorting">
                            <div class="collection-sorting position-relative d-none d-lg-block">
                                <div class="sorting-header text_16 d-flex align-items-center justify-content-end">
                                    ...
                                    <span class="active-sorting {{ empty($sortBy) ? 'active-sorting' : '' }}">Featured</span>
                                ...
                                <ul class="sorting-lists list-unstyled m-0">
                                    <li>
                                        <a href="#" wire:click.prevent="$set('sortBy', 'name_asc')" class="text_14 {{ $sortBy === 'name_asc' ? 'active-sorting' : '' }}">
                                            Alphabetically, A-Z
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click.prevent="$set('sortBy', 'name_desc')" class="text_14 {{ $sortBy === 'name_desc' ? 'active-sorting' : '' }}">
                                            Alphabetically, Z-A
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click.prevent="$set('sortBy', 'price_asc')" class="text_14 {{ $sortBy === 'price_asc' ? 'active-sorting' : '' }}">
                                            Price, low to high
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click.prevent="$set('sortBy', 'price_desc')" class="text_14 {{ $sortBy === 'price_desc' ? 'active-sorting' : '' }}">
                                            Price, high to low
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click.prevent="$set('sortBy', 'date_asc')" class="text_14 {{ $sortBy === 'date_asc' ? 'active-sorting' : '' }}">
                                            Date, old to new
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click.prevent="$set('sortBy', 'date_desc')" class="text_14 {{ $sortBy === 'date_desc' ? 'active-sorting' : '' }}">
                                            Date, new to old
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="product-gallery product-gallery-vertical d-flex">
                                <div class="product-img-large">
                                    <div class="qv-large-slider img-large-slider common-slider"
                                        ...
                                        <div class="img-large-wrapper">
                                            <img src="{{ 'assets/front/img/products/bags/38.jpg' }}" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                            <img src="{{ 'assets/front/img/products/bags/37.jpg' }}" alt="img">
                                        </div>
                                        <div class="img-large-wrapper">
                                ...
                                <div class="misc d-flex align-items-end justify-content-between mt-4">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <button class="qty-btn dec-qty"><img
                                                src="{{ 'assets/front/img/icon/minus.svg" alt=' }}"minus"></button>
                                        <input class="qty-input" type="number" name="qty" value="1"
                                            min="0">
                                        <button class="qty-btn inc-qty"><img
                                                src="{{ 'assets/front/img/icon/plus.svg" alt="' }}plus"></button>
                                    </div>
